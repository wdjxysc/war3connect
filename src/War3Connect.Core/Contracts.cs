...
public sealed record CreateRoom(string Name, string Password, string GameVersion, string MapName, string MapSha256, int Capacity = 8);
public sealed record JoinRoom(string Password, string GameVersion, string MapSha256);
...
public sealed record RoomView(string Id, string Name, string HostId, string HostName, string GameVersion,
    string MapName, string MapSha256, int Capacity, bool HasPassword, MemberView[] Members, ChatView[] Messages, GameView? Game);
public sealed record TunnelView(string Id);
public sealed record HealthView(string Status, string Version);
