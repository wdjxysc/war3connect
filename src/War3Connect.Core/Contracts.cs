...
public sealed record CreateRoom(string Name, string Password, string GameVersion, int Capacity = 8, string GameId = GameCatalog.War3);
public sealed record JoinRoom(string Password, string GameVersion, string GameId = GameCatalog.War3);
...
public sealed record RoomView(string Id, string Name, string HostId, string HostName, string GameVersion,
    int Capacity, bool HasPassword, MemberView[] Members, ChatView[] Messages, GameView? Game, string GameId = GameCatalog.War3);
...
public static class Versions
{
    ...
    public const string Release = "0.4.0";
